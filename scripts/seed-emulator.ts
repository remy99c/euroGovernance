...
export async function seedEmulatorData() {
  ...
  // ISO 27001 Certificate Evidence
  await db.doc(`tenants/${tenantId}/evidence/ev_iso27001_cert`).set({
    id: 'ev_iso27001_cert',
    tenantId,
    title: 'TÜV Rheinland ISO/IEC 27001:2022 Official Accredited Certificate',
    description: 'Formal accredited Information Security Management System certificate issued by TÜV Rheinland.',
    status: 'valid',
    category: 'cert_iso',
    controlIds: ['ctrl_iso27001_a5_1', 'ctrl_iso27001_a8_1'],
    requirementIds: ['iso_27001_req_5'],
    certificationIds: ['cert_iso_27001'],
    currentVersion: 1,
    storagePath: `tenants/${tenantId}/evidence/ev_iso27001_cert/tuv_iso27001_certificate_signed.pdf`,
    downloadUrl: 'https://storage.googleapis.com/demo/tuv_iso27001_certificate_signed.pdf',
    fileName: 'tuv_iso27001_certificate_signed.pdf',
    fileSizeBytes: 1048576,
    sha256Hash: 'b45c7e9123456789abcdef0123456789abcdef0123456789abcdef0123456789',
    reviewedBy: 'usr_security_01',
    reviewedAt: now,
    reviewDueDate: new Date(Date.now() + 365 * 24 * 60 * 60 * 1000).toISOString(),
    createdAt: now,
    updatedAt: now,
    createdBy: 'usr_compliance_01',
    updatedBy: 'usr_security_01',
  });

  // SOC 2 Type II Report Evidence
  await db.doc(`tenants/${tenantId}/evidence/ev_soc2_report`).set({
    id: 'ev_soc2_report',
    tenantId,
    title: 'PwC SOC 2 Type II Attestation Report (Security & Confidentiality)',
    description: 'Independent Service Auditor report issued by PricewaterhouseCoopers GmbH WPG.',
    status: 'valid',
    category: 'soc_report',
    controlIds: ['ctrl_iso27001_a5_1'],
    requirementIds: [],
    certificationIds: ['cert_soc2_type2'],
    currentVersion: 1,
    storagePath: `tenants/${tenantId}/evidence/ev_soc2_report/pwc_soc2_type2_2025_report.pdf`,
    downloadUrl: 'https://storage.googleapis.com/demo/pwc_soc2_type2_2025_report.pdf',
    fileName: 'pwc_soc2_type2_2025_report.pdf',
    fileSizeBytes: 2097152,
    sha256Hash: 'c78d9e0123456789abcdef0123456789abcdef0123456789abcdef0123456789',
  ...
  // ISO 42001 AIMS Certificate Evidence
  await db.doc(`tenants/${tenantId}/evidence/ev_iso42001_cert`).set({
    id: 'ev_iso42001_cert',
    tenantId,
    title: 'BSI Group ISO/IEC 42001:2023 Artificial Intelligence Certificate',
    description: 'Accredited Artificial Intelligence Management System Certificate for EU AI Act compliance.',
    status: 'valid',
    category: 'cert_iso',
    controlIds: ['ctrl_iso27001_a5_1'],
    requirementIds: [],
    certificationIds: ['cert_iso_42001'],
    currentVersion: 1,
    storagePath: `tenants/${tenantId}/evidence/ev_iso42001_cert/bsi_iso42001_certificate_signed.pdf`,
    downloadUrl: 'https://storage.googleapis.com/demo/bsi_iso42001_certificate_signed.pdf',
    fileName: 'bsi_iso42001_certificate_signed.pdf',
    fileSizeBytes: 1572864,
    sha256Hash: 'd90e1f0123456789abcdef0123456789abcdef0123456789abcdef0123456789',
    reviewedBy: 'usr_ai_01',
    reviewedAt: now,
    reviewDueDate: new Date(Date.now() + 365 * 24 * 60 * 60 * 1000).toISOString(),
    createdAt: now,
    updatedAt: now,
  ...
  // 10. Seed Structured Certifications & External Assurance Records
  console.log('🏆 Seeding Structured Certifications & External Assurance...');
  await db.doc(`tenants/${tenantId}/certifications/cert_iso_27001`).set({
    id: 'cert_iso_27001',
    tenantId,
    certificationName: 'ISO/IEC 27001:2022 ISMS Certificate',
    certificationType: 'iso_27001',
    issuingBody: 'TÜV Rheinland Cert GmbH',
    certificateNumber: '01 104 219804',
    scopeDescription: 'Development, operation, and maintenance of the euroGovernance Sovereign GRC SaaS platform and associated cloud infrastructure.',
    ...
    leadAuditorContact: 'frank.meier@de.tuv.com',
    frameworkIds: ['iso_27001'],
    linkedControlIds: ['ctrl_iso27001_a5_1', 'ctrl_iso27001_a8_1'],
    linkedEvidenceIds: ['ev_iso27001_cert'],
    linkedVendorIds: ['vnd_aws_emea'],
    linkedProcessorProfileIds: ['prof_aws_hosting'],
    linkedSystemAssetIds: ['asset_saas_platform'],
    continuousComplianceStatus: 'compliant',
    unresolvedFindingsCount: 0,
    notes: 'Stage 2 audit passed with zero major non-conformities.',
    ownerId: 'usr_admin_01',
    createdBy: 'usr_admin_01',
    updatedBy: 'usr_admin_01',
    createdAt: now,
  ...
  await db.doc(`tenants/${tenantId}/certifications/cert_soc2_type2`).set({
    id: 'cert_soc2_type2',
    tenantId,
    certificationName: 'SOC 2 Type II Security & Confidentiality Report',
    certificationType: 'soc2_type2',
    issuingBody: 'PricewaterhouseCoopers GmbH WPG',
    certificateNumber: 'PWC-SOC2-2025-DE',
    scopeDescription: 'Trust Services Criteria for Security and Confidentiality covering production cloud workloads in Frankfurt (AWS eu-central-1).',
    applicableStandardVersion: 'AICPA TSP 100 (2017)',
    issueDate: '2025-10-01T00:00:00.000Z',
    expiryDate: '2026-09-30T23:59:59.000Z',
    status: 'active_valid',
    surveillanceAuditDueDate: '2026-08-01T00:00:00.000Z',
    leadAuditorName: 'Stefan Richter',
    leadAuditorContact: 'stefan.richter@pwc.com',
    frameworkIds: ['iso_27001', 'gdpr'],
    linkedControlIds: ['ctrl_iso27001_a5_1'],
    ...
    continuousComplianceStatus: 'compliant',
    unresolvedFindingsCount: 0,
    notes: 'Annual Type II attestation period October 2024 to September 2025.',
  ...
  await db.doc(`tenants/${tenantId}/certifications/cert_iso_42001`).set({
    id: 'cert_iso_42001',
    tenantId,
    certificationName: 'ISO/IEC 42001:2023 Artificial Intelligence Management System',
    certificationType: 'iso_42001',
    issuingBody: 'BSI Group The Netherlands B.V.',
    certificateNumber: 'AIMS-89104-EU',
    scopeDescription: 'Governance, risk evaluation, and responsible lifecycle development of EU AI Act compliant enterprise AI governance models.',
    applicableStandardVersion: 'ISO/IEC 42001:2023',
    issueDate: '2025-11-15T00:00:00.000Z',
    expiryDate: '2028-11-14T23:59:59.000Z',
    status: 'active_valid',
    surveillanceAuditDueDate: '2026-10-15T00:00:00.000Z',
    leadAuditorName: 'Karin Lindqvist',
    leadAuditorContact: 'karin.lindqvist@bsigroup.com',
    frameworkIds: ['iso_42001', 'eu_ai_act'],
    linkedControlIds: ['ctrl_iso27001_a5_1'],
    linkedEvidenceIds: ['ev_iso42001_cert'],
    linkedVendorIds: [],
    linkedProcessorProfileIds: [],
    linkedSystemAssetIds: ['asset_saas_platform'],
    continuousComplianceStatus: 'compliant',
    unresolvedFindingsCount: 0,
    notes: 'Dual certification alongside ISO 27001.',
    ownerId: 'usr_ai_01',
    createdBy: 'usr_ai_01',
    updatedBy: 'usr_ai_01',
    createdAt: now,
