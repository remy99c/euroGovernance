  ...
  describe('Model Shape & Relational Contracts', () => {
    ...
    test('TenantScopeProfile instantiates with relational entity bindings', () => {
      const scopeProfile: TenantScopeProfile = {
        ...
        version: '1.2',
        revisionNumber: 1,
        revisionRationale: 'Baseline approved scope',
        supersededProfileId: null,
        applicableFrameworkIds: ['gdpr', 'iso_27001', 'eu_ai_act'],
        narrativeStatement: 'Comprehensive scope covering all EU customer data and AI models across Frankfurt and Stockholm.',
        includedLegalEntities: ['EuroCorp Technologies SE'],
        includedBusinessUnits: ['Engineering', 'Cloud Infrastructure'],
        includedLocations: ['Frankfurt am Main', 'Stockholm'],
        includedJurisdictions: ['DE', 'SE', 'EU'],
