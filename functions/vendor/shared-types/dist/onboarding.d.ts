...
export interface OnboardingAnalyticsEvent {
    eventName: 'onboarding_started' | 'onboarding_step_viewed' | 'onboarding_step_completed' | 'onboarding_dismissed' | 'onboarding_resumed' | 'onboarding_completed' | 'genesis_launch_triggered';
    tenantId: string;
    userId: string;
    role: UserRole;
    stepId?: string;
