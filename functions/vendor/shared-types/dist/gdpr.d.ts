...
export type LegalBasisType = 'consent' | 'contractual_necessity' | 'legal_obligation' | 'vital_interests' | 'public_task' | 'legitimate_interests';
export type DPIAStatus = 'screening' | 'not_required' | 'draft' | 'in_review' | 'dpo_consulted' | 'approved' | 'rejected' | 'prior_consultation_required';
export type TIAStatus = 'draft' | 'in_review' | 'approved' | 'restricted' | 'rejected';
export type TransferMechanism = 'adequacy_decision' | 'standard_contractual_clauses' | 'binding_corporate_rules' | 'derogation_art49' | 'other';
export type BreachSeverity = 'low' | 'medium' | 'high' | 'critical';
export type BreachStatus = 'suspected' | 'investigating' | 'confirmed_non_reportable' | 'dpa_notified' | 'data_subjects_notified' | 'closed';
export type DSRType = 'access' | 'rectification' | 'erasure' | 'restriction' | 'data_portability' | 'object' | 'automated_decision_making';
...
export type BreachReportingSource = 'reported_by_processor' | 'identified_internally' | 'third_party_notice' | 'dpa_inquiry';
/**
