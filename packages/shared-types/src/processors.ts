...
export function findProcessorCertificationsForControl(
  ...
  return certs.filter((certification) =>
    Boolean(certification.linkedControlIds?.includes(controlId))
  );
}
